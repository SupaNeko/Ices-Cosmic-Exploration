...
namespace ICE.Ui.MainUi.Settings
{
    internal class StopWhen
    {
        ...
        public static void Draw()
        {
            ...
            if (ImGui.Checkbox($"停止于宇宙信用点", ref stopCosmic))
            {
            ...
            if (ImGui.Checkbox($"停止于行星信用点金额", ref stopLunar))
            {
            ...
            if (ImGui.Checkbox($"停止于宇宙分数", ref stopScore))
            {
            ...
            if (ImGui.Checkbox($"停止于等级", ref stopWhenLevel))
            {
            ...
            if (ImGui.Checkbox($"停止@宇宙工具完成", ref relicStop))
            {
            ...
            if (ImGui.Checkbox("停止时播放声音警报", ref playSoundAlert))
            {
