...
本表记录 ICE 插件汉化过程中采用的固定译名，供后续维护与校对参考。

| 英文/原文 | 采用译名 | 说明 |
|---|---|---|
| Relic / Relic Grind | 宇宙工具 / 宇宙工具升级 | 指宇宙探索中可升级的制作/采集工具任务线 |
| Relic Turnin | 宇宙工具上交 | 向 Researchway 提交已升级的宇宙工具 |
| Red Alert / Critical | 紧急任务 | 地图上随机刷新的红色高优先级任务 |
| Timed | 限时 | 具有特定时间窗口的任务 |
| Provisional | 临时任务 | 天气/限时/序列等额外任务 |
| Sequence | 连续任务 | 需要按顺序完成的任务链 |
| Gold Completion / Gold | 达成金星 / 金星 | 任务最高完成评级 |
| Silver | 银星 | 任务次级完成评级 |
| Bronze | 铜星 | 任务基础完成评级 |
| Sinus Ardorum | 憧憬湾 | 宇宙探索星球之一 |
| Phaenna | 法恩娜行星 | 宇宙探索星球之一 |
| Oizys | 俄匊斯行星 | 宇宙探索星球之一 |
| Auxesia | 奥克塞西亚行星 | 宇宙探索星球之一 |
| Cosmo Credits | 宇宙信用点 | 通用兑换货币 |
| Planetary Credits / Lunar Credits | 行星信用点 | 按当前星球区分的兑换货币 |
| Gathering / Gather | 采集 | 园艺工/采矿工/捕鱼人相关活动 |
| Botanist / Miner / Fisher | 园艺工 / 采矿工 / 捕鱼人 | FFXIV 官方职业名称 |
| Hub Activities | 自动寻路 | 返回中心区域进行购物/修复/抽奖等 |
| Leveling Grind | 练级刷取 | 以提升职业等级为目标的模式 |
